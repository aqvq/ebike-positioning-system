...
/**
 * @brief 文件上传过程中，消息限流可以重新调用@ref aiot_mqtt_upload_open_stream 使用@ref AIOT_MQTT_UPLOAD_FILE_MODE_APPEND
 *
 */
 ...
 *
 * @return aiot_mqtt_upload_result_t 返回消息包括两个<i>code</i>, <i>file_name</i>; 更多信息请参考 @ref aiot_mqtt_upload_result_t
